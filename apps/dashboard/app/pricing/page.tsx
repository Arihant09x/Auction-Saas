...
function PlanCard({ plan }: { plan: typeof PLANS[0] }) {
  ...
  return (
    ...
    >
      ...
      <Link
        href={targetUrl}
        className={`mt-auto w-full py-2.5 rounded-[99px] font-bold text-[14px] border hover:opacity-90 transition text-center font-epilogue block ${plan.highlight ? "bg-[#FFBA00] text-[#012972] border-[#FFBA00]" : "bg-[#00379d] text-white border-[#00379d]"}`}
      >
        Select
      </Link>
    </div>
